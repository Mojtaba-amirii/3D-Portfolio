    ...
    <section className=" relative w-full h-screen mx-auto">
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I&apos;m <span className=" text-green-600">Mojtaba</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I develop web and mobile <br className="sm:block hidden" />{" "}
            applications with an eye on 3D visuals.
          </p>
        </div>
      </div>
      <ComputersCanvas />
      ...
      <div className=" absolute xs:bottom-10 bottom-32 w-full flex justify-center items-center">
        <a href="#about" title="about">
          <div className=" w-8.75 h-16 rounded-3xl border-4 border-secondary flex justify-center items-center p-2 ">
            <motion.div
              animate={{
                y: [0, 24, 0],
              }}
